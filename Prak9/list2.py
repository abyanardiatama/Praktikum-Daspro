...
#DefSpek
#LGenap : list of integer --> list of integer
#LGenap(L) menghasilkan sebuah list of integer yang beranggotakan angka prima saja dengan menghilangkan elemen yang bukan prima
...
#MultiRember(x,L) menghapus semua elemen x dari list
